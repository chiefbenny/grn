...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function Action1() 
        {
            $('#BtnCambiosDocP').trigger('click');
            $('label[id*=LbError]').text('');
        }

        function Action2() {
            $('#BtnCambiosDocNOCOn').trigger('click');
            $('label[id*=LbError]').text('');
        ...
        function ShowMessageWithAction() {
            var text1 = $('#<%=LbError.ClientID%>').html();
            $('label[id*=LbError]').text('');
            modalWin.ShowConfirmationMessage(text1, 300, 800, 'Importante', null, 'Si folio consecutivo', Action1, 'No', Action2);
...
<%--            oculto--%>
            ...
            <asp:Label ID="apuntadorfacturaP" runat="server" Text="0"  CssClass="oculto" >0</asp:Label>
            <asp:Label ID="apuntadorEP" runat="server" Text="0" CssClass="oculto" >0</asp:Label>
            <asp:Label ID="apuntadorNP" runat="server" Text="0" CssClass="oculto" >0</asp:Label>
            <asp:Label ID="apuntadorfacturaD" runat="server" Text="0" CssClass="oculto" >0</asp:Label>
            <asp:Label ID="apuntadorED" runat="server" Text="0"  CssClass="oculto" >0</asp:Label>
            <asp:Label ID="apuntadorND" runat="server" Text="0" CssClass="oculto" >0</asp:Label>
            <asp:Button ID="BtnCambiosDocP" OnClick="BtnCambiosDocP_Click" runat="server" Text="Con" CssClass="oculto" />
            <asp:Button ID="BtnCambiosDocNOCOn" runat="server" Text="NoCon" CssClass="oculto"  onclick="BtnCambiosDocNOCOn_Click" />
